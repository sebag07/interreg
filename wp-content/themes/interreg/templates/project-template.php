                                ...
                                <ol class="breadcrumb-link">
                                    ...
                                    <li class="active" aria-current="page">
                                        ...
                                        if (function_exists('pll_current_language')) {
                                            ...
                                            echo ($current_lang == 'ro') ? 'Detaliile proiectului' : 'Project Details';
                                        } else {
                                            _e('Project Details', 'interreg');
                                        }
                                        ?>
                                    </li>
                                </ol>
                        ...
                        <div class="col-xxl-6 col-xl-5 col-lg-6">
                            <div class="project-content-box">
                                ...
                                <h4 class="title-tag text-gradient">
                                        ...
                                        if (function_exists('pll_current_language')) {
                                            $current_lang = pll_current_language();
                                            echo ($current_lang == 'ro') ? 'DESPRE PROIECT' : 'ABOUT PROJECT';
                                        } else {
                                            _e('ABOUT PROJECT', 'interreg');
                                        }
                                        ?>
                                    </h4>                                    
                ...
                <div class="container">
                    <div class="row justify-content-between">
                        ...
                        <div class="image">
                                    <?php
                                    if (function_exists('get_field')) {
                                        $project_image = get_field('project_second_image');
                                        if ($project_image) {
                                            echo wp_get_attachment_image($project_image['ID'], 'full', false, array('alt' => get_the_title()));
                                        } else {
                                            echo '<img src="' . get_template_directory_uri() . '/assets/images/project/project-2.webp" alt="' . get_the_title() . '">';
                                        }
                                    } else {
                                        echo '<img src="' . get_template_directory_uri() . '/assets/images/project/project-2.webp" alt="' . get_the_title() . '">';
                                    }
                        ...
                        <div class="col-xxl-6 col-xl-5 col-lg-6">
                            <div class="project-content-box">
                                ...
                                <h3 class="sub-title">
                                        ...
                                        if (function_exists('pll_current_language')) {
                                            $current_lang = pll_current_language();
                                            echo ($current_lang == 'ro') ? 'Informații' : 'Information';
                                        } else {
                                            _e('Information', 'interreg');
                                        }
                                        ?>
                                    </h3>                                </div>
