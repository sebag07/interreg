...
<footer class="footer-section footer-bg" role="contentinfo">
    <!-- Start Footer Center -->
            ...
            <div class="row justify-content-xl-between">
                <div class="col-xl-auto col-md-6 col-12">
                    <div class="footer-widget-single-item">
                        ...
                        <ul class="footer-about" aria-label="Contact Information">
                            <?php
                ...
                <div class="col-xl-auto col-md-6 col-12">
                    <div class="footer-widget-single-item">
                        ...
                        <ul class="footer-blog" aria-label="Recent Events">
                            <?php 
                            $args = array(
