...
function interreg_enqueue_styles(): void {
	...
	wp_enqueue_style('swiper', $theme_uri . '/assets/css/plugins/swiper-bundle.min.css');
	...
	wp_enqueue_script('ajax-mail', $theme_uri . '/assets/js/plugins/ajax-mail.js', array('jquery'), null, true);
